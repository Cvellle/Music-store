...
/***/ "./assets/scripts/data/imagesPaths.json":
/*!**********************************************!*\
  !*** ./assets/scripts/data/imagesPaths.json ***!
  \**********************************************/
...
eval("module.exports = JSON.parse(\"[{\\\"id\\\":1,\\\"name\\\":\\\"Business development\\\",\\\"mobileSrc\\\":\\\"./assets/images/mobile/Slide 1@1X.png\\\",\\\"desktopSrc\\\":\\\"./assets/images/Slide 1@1X.png\\\"},{\\\"id\\\":2,\\\"name\\\":\\\"Constructive thinking\\\",\\\"mobileSrc\\\":\\\"./assets/images/mobile/Slide 2@1X.png\\\",\\\"desktopSrc\\\":\\\"./assets/images/Slide 2@1X.png\\\"},{\\\"id\\\":3,\\\"name\\\":\\\"Work strategy\\\",\\\"mobileSrc\\\":\\\"./assets/images/mobile/Slide 3@1X.png\\\",\\\"desktopSrc\\\":\\\"./assets/images/Slide 3@1X.png\\\"},{\\\"id\\\":4,\\\"name\\\":\\\"Team spirit\\\",\\\"mobileSrc\\\":\\\"./assets/images/mobile/Slide 4@1X.png\\\",\\\"desktopSrc\\\":\\\"./assets/images/Slide 4@1X.png\\\"}]\");\n\n//# sourceURL=webpack:///./assets/scripts/data/imagesPaths.json?");
...
"use strict";
eval("\n\n__webpack_require__(/*! ../styles/main.scss */ \"./assets/styles/main.scss\");\n\n__webpack_require__(/*! ./modules/slider.js */ \"./assets/scripts/modules/slider.js\");\n\n__webpack_require__(/*! ./modules/loadSliderImages.js */ \"./assets/scripts/modules/loadSliderImages.js\");\n\n__webpack_require__(/*! ./modules/mobileNavToggle.js */ \"./assets/scripts/modules/mobileNavToggle.js\");\n\n__webpack_require__(/*! ./modules/headerTranslate.js */ \"./assets/scripts/modules/headerTranslate.js\");\n\n__webpack_require__(/*! ./modules/startCounterOnScroll.js */ \"./assets/scripts/modules/startCounterOnScroll.js\");\n\n//# sourceURL=webpack:///./assets/scripts/index.js?");

/***/ }),

/***/ "./assets/scripts/modules/headerTranslate.js":
/*!***************************************************!*\
  !*** ./assets/scripts/modules/headerTranslate.js ***!
  \***************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _imagesPaths = __webpack_require__(/*! ../data/imagesPaths.json */ \"./assets/scripts/data/imagesPaths.json\");\n\nvar _imagesPaths2 = _interopRequireDefault(_imagesPaths);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar sliderImagesArray = document.querySelectorAll(\".sliderSection__imgWrapper > img\");\n\nvar screenWidthLimit = window.matchMedia(\"screen and (min-width: 1024px)\");\n\nif (!screenWidthLimit.matches) {\n  _imagesPaths2.default.forEach(function (el, i) {\n    sliderImagesArray[i].src = el.mobileSrc;\n    sliderImagesArray[i].alt = el.name;\n  });\n} else {\n  _imagesPaths2.default.forEach(function (el, i) {\n    sliderImagesArray[i].src = el.desktopSrc;\n    sliderImagesArray[i].alt = el.name;\n  });\n}\n\n//# sourceURL=webpack:///./assets/scripts/modules/loadSliderImages.js?");
...
"use strict";
eval("\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction startCounterOnScroll() {\n  var scrolledToFacts = false;\n\n  function startProgress() {\n    var counter = [].concat(_toConsumableArray(document.querySelectorAll(\".numbers__count--timer\")));\n    var startCounterAt = document.querySelector(\".numbers\");\n\n    var position = startCounterAt.getBoundingClientRect().top - window.innerHeight + window.innerHeight / 10;\n    var CounterCondition = position < 0;\n\n    var numbers = [7890, 1509, 5972];\n    var totalTime = 2000;\n    var counterTime = numbers.map(function (num) {\n      return totalTime / num;\n    });\n\n    function startAll() {\n      if (!scrolledToFacts) {\n        numbers.forEach(function (num, index) {\n          var element = counter[index];\n          var time = counterTime[index];\n\n          var _loop = function _loop(i) {\n            setTimeout(function () {\n              i !== 1 ? element.innerHTML = i : element.innerHTML = i + \"M\";\n            }, i * time);\n          };\n\n          for (var i = 0; i <= num; i++) {\n            _loop(i);\n          }\n        });\n      }\n    }\n\n    if (CounterCondition) {\n      startAll();\n      scrolledToFacts = true;\n    }\n  }\n  window.addEventListener(\"scroll\", startProgress);\n}\n\nwindow.addEventListener(\"load\", startCounterOnScroll);\n\n//# sourceURL=webpack:///./assets/scripts/modules/startCounterOnScroll.js?");
